...
│   │   ├── TeamController.cs
│   │   ├── RunnerController.cs
│   │   ├── RaceSectionController.cs
│   │   ├── SectionImportController.cs
│   │   ├── SectionExportController.cs
│   │   ├── RunnerSectionController.cs
│   │   └── WayPointController.cs
│   ├── Services/                     # Business logic layer
│   ├── Repositories/                 # Data access layer
│   ├── Models/                       # Domain models + DTOs
│   ├── Data/                         # DbContext + Seeder
│   ├── Middleware/                   # JWT blacklist
│   ├── Mappings/                     # Mapster config
│   └── Enums/                        # RaceType, WayPointMatchStatus
│
├── RunningRacesApi.Tests/            # 🧪 Unit Tests
│
├── running-races-ui/                 # 🌐 Angular Frontend
│   ├── src/app/
│   │   ├── components/               # Shared components
│   │   ├── features/
│   │   │   ├── relay-planner/        # Relay race planner module
│   │   │   │   ├── components/
│   │   │   │   │   ├── section-list/
│   │   │   │   │   ├── section-import/
│   │   │   │   │   ├── team-list/
...
- **Sections** – Race sections with waypoints and distances (race-scoped)
- **Waypoints** – GPS coordinates for each transition point (race-scoped)
- **Teams** – Global teams with start time
- **Runners** – Team members with base pace
- **Planner** – Drag & drop runner-section assignment
- **Map** – Interactive Leaflet map with directional arrows
- **Team Map** – Runner assignments visualized per team with colors
- **Import/Export** – CSV import with two-step waypoint matching preview
- **Pace Calculator** – Standalone tool: calculate time, distance or pace from any two values
...
> ⚠️ If you have existing WayPoint and Section data, you must manually set the `RaceId` field in the database after migration.
...
- JWT secret is a placeholder — **replace before production deployment**
