...
describe('RunnerSectionService', () => {
    ...
    it('should get assignments by team', () => {
        ...
        service.getByTeam(mockRaceId, mockCategoryId, 1).subscribe(data => expect(data).toEqual(mockData));
        httpMock.expectOne(`${environment.apiUrl}/race/${mockRaceId}/category/${mockCategoryId}/team/1/assignments`).flush(mockData);
    });
    ...
    it('should save all assignments', () => {
        ...
        service.saveAll(mockRaceId, mockCategoryId, 1, assignments).subscribe();
        const req = httpMock.expectOne(`${environment.apiUrl}/race/${mockRaceId}/category/${mockCategoryId}/team/1/assignments`);
