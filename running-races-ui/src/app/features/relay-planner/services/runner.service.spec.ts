...
describe('RunnerService', () => {
    ...
    it('should get runners by team', () => {
        ...
        httpMock.expectOne(`${environment.apiUrl}/team/1/runner`).flush([mockRunner]);
    });

    it('should get runner by id', () => {
        service.getById(1, 1).subscribe(data => expect(data).toEqual(mockRunner));
        httpMock.expectOne(`${environment.apiUrl}/team/1/runner/1`).flush(mockRunner);
    });

    it('should create runner', () => {
        service.create(1, mockRunner).subscribe(data => expect(data).toEqual(mockRunner));
        const req = httpMock.expectOne(`${environment.apiUrl}/team/1/runner`);
    ...
    it('should update runner', () => {
        ...
        const req = httpMock.expectOne(`${environment.apiUrl}/team/1/runner/1`);
